...
\\
\noindent
Na tabela acima a mediana e a moda são estimativas aproximadas. \\
...
fazer formulario, e aprofundar moda media e mmediana com valores axactos \\
\\
\\
...
\\
\\
$P(Y_A < 6)=P(Y_A \leqslant 5)=F_{B_i}(5) \cong 0,3677 $  \quad e \quad $P(Y_B < 6)=P(Y_B \leqslant 5)=F_{B_i} \cong 0,2444$ \\
\\
...
$\therefore$
\\
$IC_{97\%}(\hat{P_A}-\hat{P_B})=\left[ \; (\hat{p_A}-\hat{p_B}) \:-\: 0,1289 \: ; \: (\hat{p_A}-\hat{p_B}) \:+\: 0,1289 \; \right]$ \\
\\
